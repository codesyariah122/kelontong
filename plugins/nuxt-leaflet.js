...
import "assets/images/marker/store-icon.png";
import "assets/images/marker/store-icon.png";
...
Icon.Default.mergeOptions({
  ...
  iconRetinaUrl: require('assets/images/marker/store-icon.png'),
  iconUrl: require('assets/images/marker/store-icon.png'),
  shadowUrl: require('assets/images/marker/store-icon.png'),
});
